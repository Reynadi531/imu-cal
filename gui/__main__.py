...
with dpg.window(label="IMU Calibration Tool", tag="main_window"):
    with dpg.menu_bar():
        dpg.add_text("IMU Calibration Tool | Custom Made for GY-85 Sensor and Fall Detection Research 2025", tag="title_text")
